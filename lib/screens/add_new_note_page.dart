      ...
      floatingActionButton: FloatingActionButton.extended(
        onPressed: () {
          if (controller.titleController.text.isEmpty) {
            showToast(message: "file name is empty");
          } else if (controller.contentController.text.isEmpty) {
            showToast(message: "Note description is empty");
          } else if(!controller.isValidFileName(controller.titleController.text.trim())) {
            showToast(message: "Please enter valid filename");
          }else{
